...
3. Allow AWS to create IAM roles for the identity pool. 
...
3. Run the app on the iPhone 6 simulator.
  * Minimize the app, open the Contacts app and add a contact named "Bob" with the number you've used in Step 1. 
  * Use another phone number to login and accept the prompt to upload the simulator's contacts to Digits.
  * The app will confirm that "Bob" is an existing user. 
...
This project was written in Swift 2 on Xcode 7 GM.
